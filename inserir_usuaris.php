...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $esProfe = isset($_POST["esProfe"]) ? 1 : 0;
  ...
  $stmt = $conn->prepare("INSERT INTO Alumnes (id, nom, cognom1, cognom2, correu, grupClasse, esProfe) VALUES ('$id', '$nom', '$cognom1', '$cognom2', '$correu', '$grupClasse', '$esProfe')");
