...
<div class="container">
  <div class="row">
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      // Fetch all rows from the Assignacions, Alumnes, TipusMaterial tables
      $query = "SELECT * FROM Assignacions, Alumnes, TipusMaterial WHERE Assignacions.idAlumne = Alumnes.id AND TipusMaterial.id = Assignacions.idMaterial";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo '<th scope="col">ID Material</th>';
          echo '<th scope="col">Tipo Material</th>';
          echo '</tr>';
          echo '</thead>';
          echo '<tbody>';
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo '<td>' . $row['id'] . '</td>';
              echo '<td>' . $row['nom'] . '</td>';
              echo '<td>' . $row['cognom1'] . ' ' . $row['cognom2'] . '</td>';
